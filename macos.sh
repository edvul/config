...
# default would be hibernate mode 25, but it takes longer to go in/come out.
sudo pmset -a hibernatemode 0

# This doesnt work with new paranoid mac os
...
# Set standby delay
# standby delay is what happens after a given time with lid closed and no peripherals plugged in.
...
# TODO set date/time format intelligently
